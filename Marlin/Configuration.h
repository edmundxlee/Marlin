...
// *Added* This defines the number of hoteneds to be 1 (for pins_BTT_SKR.h)
#define HOTENDS 1
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define DEFAULT_Ki 1.56  // *Added*: Originally 1.54
...
#define DEFAULT_EJERK    3.0  // May be used by Linear Advance 
                              // *Added*: Originally 5.0, now set to 3.0. See https://github.com/MarlinFirmware/Marlin/issues/16155
 ...
 */
#define S_CURVE_ACCELERATION  // *Added*: Experimental
...
#define PREHEAT_1_TEMP_HOTEND 205 // *Added*: Original 185
#define PREHEAT_1_TEMP_BED     60 // *Added*: Original 45
